...
class Author(models.Model):
    Author_User = models.OneToOneField(User)
...
class Post(models.Model):
    ...
    position = models.CharField(choices=choic, default=news)
...
class Comment(models.Model):
    ...
    comment_text = models.TextField(max_length = 255) # Из задания не ясно только авторизованные пользователи могут оставлять комментарии или нет, ограничения задано для исключения спама от гостей.
